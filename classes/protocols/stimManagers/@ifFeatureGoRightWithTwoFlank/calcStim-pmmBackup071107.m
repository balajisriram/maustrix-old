...
switch trialManagerClass
   ...
   %FUTURE CHECKS FOR FLANKERS
    ...
    flankerYokedToTargetPhase =1; %In the trialManager version this gets passed in, but here it's hard coded 
    if flankerYokedToTargetPhase
...
%%%%%%%%%% CREATE CENTERS %%%%%%%%%%%%%%
    ...
    elseif stimulus.displayTargetAndDistractor== 1
        ...
        ...%yPosPct                      yPosPct                    xPosPct                   xPosPct
            ...
            stimulus.targetYPosPct+dev   stimulus.targetYPosPct+dev    xPosPct                   xPosPct;...                   %top
            stimulus.targetYPosPct-dev   stimulus.targetYPosPct-dev    xPosPct                   xPosPct...                    %bottom
            [ stimulus.targetYPosPct       stimulus.targetYPosPct      xPosPct                   xPosPct;...                   %distractor1
            stimulus.targetYPosPct+dev   stimulus.targetYPosPct+dev    xPosPct                   xPosPct;...                   %distractor1 top
            stimulus.targetYPosPct-dev   stimulus.targetYPosPct-dev    xPosPct                   xPosPct];                     %distractor1 bottom
...
%%%%%%%%% DETERMINE SCREEN POSITIONS IN PIXELS %%%%%%%%%%%%%%%%
    ...
    pos = pos + repmat([0, 0, xPixHint, xPixHint], numPatchesInserted, 1);
