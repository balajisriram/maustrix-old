...
if ~exist('screenNum','var') || isempty(screenNum)
    ...
    if length(Screen('Screens'))>1
        ...
        if a
            switch b
                case {'001D7D9ACF80','00095B8E6171','001D7DA5B8D5'} %phys rig (00095B8E6171 is the netgear GA302T added for talking to eyelink (and returned by ptb's macid/getmac), 001D7D9ACF80 is the integrated,001D7DA5B8D5 is eriks comp salvaged for DAQ purposes)
