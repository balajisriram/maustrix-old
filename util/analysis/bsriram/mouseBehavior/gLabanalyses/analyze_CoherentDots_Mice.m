...
filters =today-10:today; %'Jun-17-2013':today
trialNumCutoff = 25;
...
filters =today-5:today; %'Jun-17-2013':today
trialNumCutoff = 25;
...
c1 = analyzeMouse(mouse,filters,plotDetails,trialNumCutoff,analysisFor,splits,compiledFilesDir);
