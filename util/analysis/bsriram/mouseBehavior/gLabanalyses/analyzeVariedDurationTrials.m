...
vardur = filterBehaviorData(data,'tsName','orDURSweep');
        ...
        case 'givenAxes'
            ...
            switch plotDetails.requestedPlot
                ...
                case 'performanceByCondition'
                    ...
                    set(gca,'ylim',[0.2 1.1],'xlim',[log10(min(varDurData.maxDurations))-0.05 log10(max(varDurData.maxDurations))+0.05],'xtick',log10(varDurData.maxDurations),'xticklabel',xlabels,'ytick',[0.2 0.5 1],'FontName','Times New Roman','FontSize',12);
