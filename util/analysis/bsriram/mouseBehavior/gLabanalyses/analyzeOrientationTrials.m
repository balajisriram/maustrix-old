function spatFreqData = analyzeOrientationTrials(mouseID,data,filters,plotDetails,trialNumCutoff,daysPBS,daysCNO,daysIntact,daysLesion)
...
spat = filterBehaviorData(data,'tsName','orORSweep_nAFC');
