...
Box1Subjects = {'223','241','246','252','250','263'};
Box2Subjects = {'232','242','247','253','254','259'};
Box3Subjects = {'227','243','248','255','256','262'};
Box4Subjects = {'218','244','249','257','258','261'};
Box5Subjects = {'218','257','258','245','250','262'};
...
onGoingExperimentSubjects = {...
    ...
    {'232'};...
    {'218','223','227','228','246','247','248','249','250','251','252','253','254','255','256','257','258','259','261','262','263'};...
    {'241','242','243','244','245'};...
    {'237','238'};...
    };
...
experimentBackupLocation = {'\\ghosh-16-159-221.ucsd.edu\ghosh\Behavior\PV-V1-hM3D\Permanent';...
    ...
    '\\ghosh-16-159-221.ucsd.edu\ghosh\Behavior\ORSweeps\Permanent';...
    '\\ghosh-16-159-221.ucsd.edu\ghosh\Behavior\VarDur\Permanent';...
    '\\ghosh-16-159-221.ucsd.edu\ghosh\Behavior\Motion\Permanent';...
    '\\ghosh-16-159-221.ucsd.edu\ghosh\Behavior\Reversal\Permanent';...
};
