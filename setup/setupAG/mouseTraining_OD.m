...
[or_optim, ~, ~, ~, or_durLimited, or_durCtr, or_durSweepEasy, or_durSweepHard] = createOrientationSteps_auto(svnRev,svnCheckMode,subID);
...
pMouseTraining_OD = protocol(descriptiveString,{fd_sto,fd,ts_obj1,ts_obj2,...
    or_optim,or_durLimited,or_durCtr,or_durSweepEasy,or_durSweepHard...
    });
end
