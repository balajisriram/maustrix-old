...
svnRev={'svn://132.239.158.177/projects/ratrix/tags/v1.0.2'};
...
ts_AFCOBJ = createEasyAFCObject(percentCorrectionTrials,tm, repeatIndefinitely(),noTimeOff(), svnRev, svnCheckMode);
